import numpy as np
from .replay_buffer import compute_rewards_to_go
...
class SeqReplayBuffer:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._rewards_to_go = np.zeros((max_replay_buffer_size, 1), dtype=np.float32)
    ...
    def add_episode(self, observations, actions, rewards, terminals, next_observations):
        ...
        self._rewards_to_go[indices] = compute_rewards_to_go(rewards, self._discount)
    ...
    def _sample_data(self, indices):
        return dict(
            ...
            rtg=self._rewards_to_go[indices],
        )
